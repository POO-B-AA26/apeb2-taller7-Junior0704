...
class MensajesMoviles{
    public Asociado remitente;
    public Asociado destinatario;

    public MensajesMoviles(Asociado remitente, Asociado destinatario) {
...
class Sms extends MensajesMoviles{
    public String texto;
...
class Mms extends MensajesMoviles{
...
public class Problema_3_EjecutorMensajesMoviles {
    public static void main(String[] args) {
        Asociado aso1 = new Asociado("0967543489", "Juan");
        Asociado aso2 = new Asociado("0933540387", "Maria");
        
        MensajesMoviles[] bandeja = new MensajesMoviles[2];
        bandeja[0] = new Sms("!GANO ECUADOOOOOOOOOOR!!!!!!", aso1, aso2);
        bandeja[1] = new Mms("foto_mundial_ecuador.png", aso2, aso1);
        
        System.out.println("--- Envio de Mensajes ---");
        for (MensajesMoviles msg : bandeja) {
            msg.enviarMensaje(); 
        }
 ...
 * run:
--- Envio de Mensajes ---
[SMS]Enviando texto: !GANO ECUADOOOOOOOOOOR!!!!!!
[MMS]Enviando imagen: foto_mundial_ecuador.png

--- Visualizacion de Mensajes ---
****SMS****
De: Juan
Para: Maria
Mensaje: !GANO ECUADOOOOOOOOOOR!!!!!!

****MMS****
De: Maria
Para: Juan
Mensaje: foto_mundial_ecuador.png
