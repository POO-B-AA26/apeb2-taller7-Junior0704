...
class Cuentas{
    ...
    public Cuentas(String nombreCliente, String numeroCuenta) {
    ...
    public String toString() {
        return "Cuentas{" + "nombreCliente=" + nombreCliente + ", numeroCuenta=" + numeroCuenta + ", balanceActual=" + balanceActual + '}';
    }
}
...
class Ahorros extends Cuentas{
    ...
    public Ahorros(double porcentajeInteres, String nombreCliente, String numeroCuenta) {
        super(nombreCliente, numeroCuenta);
...
public class Problema_6_EjecutorCuentas {
    public static void main(String[] args) {
        Cheques cuenta1 = new Cheques("Pedro Torres", "1983629452");
        Ahorros cuenta2 = new Ahorros(5, "Juana Scarlet", "09877246593");
        Platino cuenta3 = new Platino(10, "Martina Castillo", "1354892542");
        ...
        cuenta1.depositarDinero(100.0);
        cuenta1.retirarDinero(150.0); 
        cuenta2.depositarDinero(300.0);
        cuenta2.retirarDinero(400.0);
        cuenta3.depositarDinero(200.0);
        cuenta3.retirarDinero(250.0);
 ...
 * run:
====== ESTADO DE CUENTAS ======
Cheques{}Cuentas{nombreCliente=Pedro Torres, numeroCuenta=1983629452, balanceActual=0.0}
Ahorros{porcentajeInteres=5.0}Cuentas{nombreCliente=Juana Scarlet, numeroCuenta=09877246593, balanceActual=0.0}
Platino{porcentajeInteres=10.0}Cuentas{nombreCliente=Martina Castillo, numeroCuenta=1354892542, balanceActual=0.0}

====== MOVIMIENTOS BANCARIOS ======
[CUENTA DE CUEQUES]: Retiro exitoso de 150.0 $
ERROR Fondos insuficientes.No se permite sobregiro.
[CUENTA PLATINO]: Retiro exitoso de 250.0 $

====== ESTADO DE CUENTAS (REPORTE) ======
Cheques{}Cuentas{nombreCliente=Pedro Torres, numeroCuenta=1983629452, balanceActual=-50.0}
Ahorros{porcentajeInteres=5.0}Cuentas{nombreCliente=Juana Scarlet, numeroCuenta=09877246593, balanceActual=315.0}
Platino{porcentajeInteres=10.0}Cuentas{nombreCliente=Martina Castillo, numeroCuenta=1354892542, balanceActual=-55.0}
