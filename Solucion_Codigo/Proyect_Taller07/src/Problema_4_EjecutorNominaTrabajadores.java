...
class Comisionistas extends Trabajador{
    ...
    public Comisionistas(double porcentajeComision, String nombre, String apellido, String direccion, String dni) {
        super(nombre, apellido, direccion, dni);
    ...
    @Override
    public String toString() {
        return "Comisionistas{" + "ventas=" + ventas + ", porcentajeComision=" + porcentajeComision + '}'+ super.toString();
    }
}
class PorHoras extends Trabajador{
    ...
    public PorHoras(double precioNormal, double precioHoraExtra, String nombre, String apellido, String direccion, String dni) {
        super(nombre, apellido, direccion, dni);
    ...
    @Override
    public String toString() {
        return "PorHoras{" + "horas=" + horas + ", precioNormal=" + precioNormal + ", precioHoraExtra=" + precioHoraExtra + '}'+ super.toString();
    }
}
public class Problema_4_EjecutorNominaTrabajadores {
    public static void main(String[] args) {
        Jefe jefe1 = new Jefe(1500, "Pedro", "Mendez", "Loja", "0108657890");
        FijosMensuales emp1 = new FijosMensuales(500, "Maria", "Torres", "Loja", "1986572452");
        PorHoras emp2 = new PorHoras(20, 10, "Juan", "Castillo", "Zamora", "1900875643");
        Comisionistas emp3 = new Comisionistas(20, "Xavier", "Rodriguez", "Catamayo", "0187795432");
        ...
        System.out.println("====== REPORTE DE NOMINAS GENERAL DE FIN DE MES ======");
...
/**
 * run:
====== REPORTE DE NOMINAS GENERAL DE FIN DE MES ======
Jefe{sueldo=1500.0}Trabajador{nombre=Pedro, apellido=Mendez, direccion=Loja, dni=0108657890}
--------------------------------------------------
FijosMensuales{pagoMensual=500.0}Trabajador{nombre=Maria, apellido=Torres, direccion=Loja, dni=1986572452}
Sueldo Total: 500.0
--------------------------------------------------
PorHoras{horas=50.0, precioNormal=20.0, precioHoraExtra=10.0}Trabajador{nombre=Juan, apellido=Castillo, direccion=Zamora, dni=1900875643}
Sueldo Total: 900.0
--------------------------------------------------
Comisionistas{ventas=88, porcentajeComision=20.0}Trabajador{nombre=Xavier, apellido=Rodriguez, direccion=Catamayo, dni=0187795432}
Sueldo Total: 1760.0
--------------------------------------------------
